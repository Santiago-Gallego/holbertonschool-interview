...
Note: In order for the main file to compile, you are provided with the static
library called libheap.a. This library won’t be used during correction, its only purpose is for testing.
